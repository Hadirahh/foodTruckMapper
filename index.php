...
$sql = "SELECT truck_id, name AS truck_name, address, menu_name, business_hours FROM food_trucks";
                        ...
                        <tbody>
                            <?php foreach ($foodTrucks as $truck): ?>
                                <tr>
                                    ...
                                    <td><?php echo htmlspecialchars($truck['menu_name']); ?></td>
                                    <td><?php echo htmlspecialchars($truck['business_hours']); ?></td>
                                    <td><?php echo htmlspecialchars($truck['address']); ?></td>
                                    <td><a href="edit_food_truck.php?id=<?php echo $truck['truck_id']; ?>" class="edit-btn">Edit</a></td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
