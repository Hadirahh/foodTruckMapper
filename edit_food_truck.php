...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $conn->prepare("UPDATE food_trucks SET business_type=?, name=?, operator_name=?, address=?, 
            menu_name=?, business_hours=?, latitude=?, longitude=?, image=? WHERE truck_id=?");
    $stmt->bind_param("sssssssssi", $business_type, $name, $operator_name, $address, $menu_name, $business_hours, $latitude, $longitude, $image_path, $truck_id);
        ...
        <div class="form-container">
            ...
            <form method="post" action="" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    ...
                    <input type="text" id="menu_name" name="menu_name" value="<?php echo htmlspecialchars($food_truck['menu_name']); ?>" required>
                </div>
